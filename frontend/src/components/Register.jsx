                    ...
                    <div className="space-y-4">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className={`w-full border p-2 rounded-md ${
                                    errors.password ? "border-red-500 focus:ring-red-500" : "border-gray-300 focus:ring-gray-500"
                                } focus:ring-2 focus:border-gray-500 outline-none`}
                        ...
                        <div>
                            ...
                            <select
                                className={`w-full border p-2 rounded-md ${
                                    errors.role ? "border-red-500 focus:ring-red-500" : "border-gray-300 focus:ring-gray-500"
                                } focus:ring-2 focus:border-gray-500 outline-none`}
